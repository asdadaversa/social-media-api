...
class CommentaryPostSerializer(CommentarySerializer):
    author = serializers.SlugRelatedField(source="user", slug_field="full_name", read_only=True, many=False)
...
class PostSerializer(serializers.ModelSerializer):
    ...
    comments = CommentaryPostSerializer(source="posts", many=True, read_only=True)

    class Meta:
        model = Post
        fields = ("id", "photo", "title", "content", "created_time", "author", "hashtags","comments_count", "likes_count", "comments")
...
class PostListSerializer(PostSerializer):
    ...
    class Meta:
        model = Post
        fields = ("id", "photo", "title", "content", "created_time", "author", "hashtags","comments_count", "likes_count",)
        read_only_fields = ("author", )
